                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li><a href="?page=karyawan">Data Karyawan</a></li>
                            <li><a href="?page=kriteria">Kriteria</a></li>
                            <li><a href="?page=model">bobot</a></li>
                            <li><a href="?page=penilaian">sub kriteria</a></li>
                            <li class="divider"></li>
                            <li><a href="?page=nilai">alternatif</a></li>
                          </ul>
                        </li>
                        <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Laporan <span class="caret"></span></a>
                          <ul class="dropdown-menu">
                            <li><a href="?page=lap_seluruh">Seluruh Karyawan</a></li>
                            <li><a href="?page=lap_perkaryawan">Per Karyawan</a></li>
